...
def make_dataset(dir, class_to_idx, extensions):
    images = []
    dir = os.path.expanduser(dir)                                   # 它的作用是提供跨平台的路径展开功能，使得路径可以在不同的操作系统上正确地解析
    dir_len = len(dir)+1
...
class ImageFolder(data.Dataset):
    ...
    def __init__(self, root, loader=default_loader, extensions=IMG_EXTENSIONS, transform=None, target_transform=None, return_path=False):
        ...
        self.root = root
        self.loader = loader
        self.extensions = extensions                                    # 定义了图片的后缀名

        self.classes = classes
        self.class_to_idx = class_to_idx
        # samples 中包含了所有图片的 (路径,类别)，如：('test\\n01440764_15049.JPEG', 0)
        # [('root1/class_x/xxx.ext', 0), ('root1/class_x/xxy.ext', 0), ('root1/class_x/xxz.ext', 0), ('root1/class_y/123.ext', 1), ('root1/class_y/nsdf3.ext', 1), ('root1/class_y/asd932_.ext', 1)]
